...
#①查询每个部门的员工个数
SELECT COUNT(*) 员工个数, department_id 部门名称 FROM employees GROUP BY department_id;

#② 筛选刚才①结果
SELECT COUNT(*) 员工个数, department_id 部门名称 FROM employees GROUP BY department_id HAVING COUNT(*)>5;
